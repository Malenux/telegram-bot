...
class FeatureTitleFilter extends HTMLElement {
  constructor () {
    super()
    this.shadow = this.attachShadow({ mode: 'open' })
    this.endpoint = '/api/admin/feature-titles'
...
customElements.define('feature-title-filter-component', FeatureTitleFilter)
