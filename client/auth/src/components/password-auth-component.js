class PasswordAuthComponent extends HTMLElement {
  constructor () {
    super()
  ...
  loadData () {
    ...
    this.data = {
      ...
      description: 'Introduce y confirma tu nueva contraseña para finalizar la activación de tu cuenta.',
...
customElements.define('password-auth-component', PasswordAuthComponent)
